package io.playground.tiago.petstore.domain.authentication

import io.playground.tiago.petstore.domain.users.{Role, User}
...
object Auth {
  ...
  def allRoles[F[_], Auth](
    ...
    TSecAuthService.withAuthorization(_allRoles[F, AugmentedJWT[Auth, Long]])(
      pf
    )
  ...
  def allRolesHandler[F[_], Auth](
    ...
    TSecAuthService.withAuthorizationHandler(
      _allRoles[F, AugmentedJWT[Auth, Long]]
    )(
      pf,
      onNotAuthorized.run
    )
  ...
  def adminOnly[F[_], Auth](
    ...
    TSecAuthService.withAuthorization(_adminOnly[F, AugmentedJWT[Auth, Long]])(
      pf
    )
}
